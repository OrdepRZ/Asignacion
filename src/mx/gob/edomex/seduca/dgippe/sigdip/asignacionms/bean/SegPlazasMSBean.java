...
@ManagedBean
@ViewScoped
public class SegPlazasMSBean implements Serializable {
	...
	public SegPlazasMSBean() {
		...
		try {
			...
			FacesMessage msg = new FacesMessage((e.getMessage()!=null ? e.getMessage() : "SegPlazasMSBean() : Se generó un error interno en el servidor."));
