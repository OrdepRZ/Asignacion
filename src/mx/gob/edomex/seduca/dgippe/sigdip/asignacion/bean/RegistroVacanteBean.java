...
@ManagedBean
@ViewScoped
public class RegistroVacanteBean implements Serializable 
{
		...
		try 
		{
			if(cvePresupuestal != null && !cvePresupuestal.trim().equals(""))
			{
				...
				if(msjError.equals(""))
				{
					...
					{
						outcome = "/sigdip/asignacion/administracion/registroVacante.xhtml?faces-redirect=true";
